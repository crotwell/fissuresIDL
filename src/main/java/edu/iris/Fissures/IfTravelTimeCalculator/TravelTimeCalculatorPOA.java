...
//
public abstract class TravelTimeCalculatorPOA
    extends org.omg.PortableServer.Servant
    implements org.omg.CORBA.portable.InvokeHandler,
               TravelTimeCalculatorOperations
{
    ...
    _this()
    {
        return TravelTimeCalculatorHelper.narrow(super._this_object());
    }

    public TravelTimeCalculator
    _this(org.omg.CORBA.ORB orb)
    {
        return TravelTimeCalculatorHelper.narrow(super._this_object(orb));
    }
            ...
            org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        switch(_ob_index)
        {
        case 0: // calculate_travel_times
            return _OB_op_calculate_travel_times(in, handler);
        ...
        case 5: // known_models
            return _OB_op_known_models(in, handler);

        case 6: // known_phases
            return _OB_op_known_phases(in, handler);

        case 7: // reset_to_default
            return _OB_op_reset_to_default(in, handler);

        case 8: // set_configuration
    ...
    _OB_op_calculate_travel_times(org.omg.CORBA.portable.InputStream in,
                                  org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        edu.iris.Fissures.Location _ob_a2 = edu.iris.Fissures.LocationHelper.read(in);
        String _ob_a3 = VelocityModelIdHelper.read(in);
        String[] _ob_a4 = PhaseNameSeqHelper.read(in);
        PhaseNameSeqHolder _ob_ah5 = new PhaseNameSeqHolder();
        edu.iris.Fissures.IfEvent.PredictedArrival[] _ob_r = calculate_travel_times(_ob_a0, _ob_a1, _ob_a2, _ob_a3, _ob_a4, _ob_ah5);
        out = handler.createReply();
        edu.iris.Fissures.IfEvent.PredictedArrivalSeqHelper.write(out, _ob_r);
        PhaseNameSeqHelper.write(out, _ob_ah5.value);
        return out;
    }
    ...
    private org.omg.CORBA.portable.OutputStream
    _OB_op_known_models(org.omg.CORBA.portable.InputStream in,
                        org.omg.CORBA.portable.ResponseHandler handler)
    {
        org.omg.CORBA.portable.OutputStream out = null;
        String[] _ob_r = known_models();
        out = handler.createReply();
        ModelNameSeqHelper.write(out, _ob_r);
        return out;
    }

    private org.omg.CORBA.portable.OutputStream
    _OB_op_known_phases(org.omg.CORBA.portable.InputStream in,
                        org.omg.CORBA.portable.ResponseHandler handler)
    {
        org.omg.CORBA.portable.OutputStream out = null;
        String[] _ob_r = known_phases();
        out = handler.createReply();
        PhaseNameSeqHelper.write(out, _ob_r);
        return out;
    }
