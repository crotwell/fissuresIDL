...
//
public class _ChannelIdIterStub extends org.omg.CORBA.portable.ObjectImpl
                                implements ChannelIdIter
{
    ...
    final public static java.lang.Class _ob_opsClass = ChannelIdIterOperations.class;
    ...
    how_many_remain()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                ChannelIdIterOperations _ob_self = (ChannelIdIterOperations)_ob_so.servant;
                try
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    _ob_ah1.value = ChannelIdSeqHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
