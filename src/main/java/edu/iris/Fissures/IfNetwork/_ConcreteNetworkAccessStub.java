...
//
public class _ConcreteNetworkAccessStub extends org.omg.CORBA.portable.ObjectImpl
                                        implements ConcreteNetworkAccess
{
    ...
    final public static java.lang.Class _ob_opsClass = ConcreteNetworkAccessOperations.class;
    ...
    a_writeable()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                ConcreteNetworkAccessOperations _ob_self = (ConcreteNetworkAccessOperations)_ob_so.servant;
                try
                {
