...
//
final public class SeismicHardwareHelper
{
    public static void
    insert(org.omg.CORBA.Any any, SeismicHardware val)
    {
        any.insert_Value(val, type());
    }

    public static SeismicHardware
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            java.io.Serializable _ob_v = any.extract_Value();
            if(_ob_v instanceof SeismicHardware)
                return (SeismicHardware)_ob_v;
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/SeismicHardware:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (SeismicHardware)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, SeismicHardware val)
    {
