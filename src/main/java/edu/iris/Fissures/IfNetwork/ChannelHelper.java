...
//
final public class ChannelHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Channel val)
    {
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            if(_ob_v instanceof Channel)
                return (Channel)_ob_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[2].name = "an_orientation";
            members[2].type = edu.iris.Fissures.OrientationHelper.type();
            members[2].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            members[3] = new org.omg.CORBA.ValueMember();
            members[3].name = "sampling_info";
            members[3].type = edu.iris.Fissures.SamplingHelper.type();
            members[3].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            members[4] = new org.omg.CORBA.ValueMember();
            members[4].name = "effective_time";
            members[4].type = edu.iris.Fissures.TimeRangeHelper.type();
            members[4].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            members[5] = new org.omg.CORBA.ValueMember();
            members[5].name = "my_site";
            members[5].type = SiteHelper.type();
            members[5].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            typeCode_ = orb.create_value_tc(id(), "Channel", org.omg.CORBA.VM_NONE.value, null, members);
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/Channel:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (Channel)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Channel val)
    {
