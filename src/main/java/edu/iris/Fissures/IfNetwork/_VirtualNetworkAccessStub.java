...
//
public class _VirtualNetworkAccessStub extends org.omg.CORBA.portable.ObjectImpl
                                       implements VirtualNetworkAccess
{
    ...
    final public static java.lang.Class _ob_opsClass = VirtualNetworkAccessOperations.class;
    ...
    a_writeable()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                VirtualNetworkAccessOperations _ob_self = (VirtualNetworkAccessOperations)_ob_so.servant;
                try
                {
