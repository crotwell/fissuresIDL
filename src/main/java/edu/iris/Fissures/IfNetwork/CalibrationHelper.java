...
//
final public class CalibrationHelper
{
    public static void
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            if(_ob_v instanceof Calibration)
                return (Calibration)_ob_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_value_tc(id(), "Calibration", org.omg.CORBA.VM_NONE.value, null, members);
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/Calibration:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (Calibration)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }
