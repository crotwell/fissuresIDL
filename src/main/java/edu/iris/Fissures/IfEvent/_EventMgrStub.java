...
//
public class _EventMgrStub extends org.omg.CORBA.portable.ObjectImpl
                           implements EventMgr
{
    ...
    final public static java.lang.Class _ob_opsClass = EventMgrOperations.class;
    ...
    a_factory()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                EventMgrOperations _ob_self = (EventMgrOperations)_ob_so.servant;
                try
                {
