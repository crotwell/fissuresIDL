...
//
final public class EventAccessHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "EventAccess");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfEvent/EventAccess:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _EventAccessStub _ob_stub = new _EventAccessStub();
