...
{
    public static void
    insert(org.omg.CORBA.Any any, TimeSeriesAccess val)
    {
    ...
    public static TimeSeriesAccess
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof TimeSeriesAccess)
                    return (TimeSeriesAccess)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "TimeSeriesAccess");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfTimeSeries/TimeSeriesAccess:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, TimeSeriesAccess val)
    {
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _TimeSeriesAccessStub _ob_stub = new _TimeSeriesAccessStub();
