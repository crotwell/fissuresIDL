...
//
final public class DimensionHelper
{
    public static void
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/Dimension:1.0";
    }

    public static Dimension
    read(org.omg.CORBA.portable.InputStream in)
    {
        Dimension _ob_v = new Dimension();
