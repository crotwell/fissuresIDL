...
//
public class _SeismogramStub extends org.omg.CORBA.portable.ObjectImpl
                             implements Seismogram
{
    ...
    final public static java.lang.Class _ob_opsClass = SeismogramOperations.class;
    ...
    a_writeable()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                SeismogramOperations _ob_self = (SeismogramOperations)_ob_so.servant;
                try
                {
    ...
    //
    public void
    process_time_corrections(edu.iris.Fissures.AuditInfo[] _ob_a0)
        throws edu.iris.Fissures.NotImplemented
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("process_time_corrections", true);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a0);
                    in = _invoke(out);
                    return;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("process_time_corrections", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                SeismogramOperations _ob_self = (SeismogramOperations)_ob_so.servant;
                try
                {
                    _ob_self.process_time_corrections(_ob_a0);
                    return;
                }
                finally
                {
    ...
    //
    public void
    set_attributes(edu.iris.Fissures.IfSeismogramDC.SeismogramAttr _ob_a0,
        ...
        throws edu.iris.Fissures.FissuresException
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("set_attributes", true);
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("set_attributes", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                SeismogramOperations _ob_self = (SeismogramOperations)_ob_so.servant;
                try
                {
                    ...
                    _ob_self.set_attributes(_ob_a0, _ob_a1);
                    return;
                }
                finally
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    edu.iris.Fissures.IfTimeSeries.LongSeqHelper.write(out, _ob_a1);
                ...
                catch(org.omg.CORBA.portable.ApplicationException _ob_aex)
                {
                    ...
                    if(_ob_id.equals(edu.iris.Fissures.IfTimeSeries.SequenceOutOfOrderHelper.id()))
                        throw edu.iris.Fissures.IfTimeSeries.SequenceOutOfOrderHelper.read(in);
                    throw new org.omg.CORBA.UNKNOWN("Unexpected User Exception: " + _ob_id);
                }
                finally
                {
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_long(_ob_a0);
                    edu.iris.Fissures.IfTimeSeries.ShortSeqHelper.write(out, _ob_a1);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a2);
                    in = _invoke(out);
                    return;
                }
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_long(_ob_a0);
                    edu.iris.Fissures.IfTimeSeries.FloatSeqHelper.write(out, _ob_a1);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a2);
                    in = _invoke(out);
                    return;
                }
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_long(_ob_a0);
                    edu.iris.Fissures.IfTimeSeries.DoubleSeqHelper.write(out, _ob_a1);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a2);
                    in = _invoke(out);
                    return;
                }
    ...
    append_encoded_seq(int _ob_a0,
                       edu.iris.Fissures.IfTimeSeries.EncodedData[] _ob_a1,
                       edu.iris.Fissures.AuditInfo[] _ob_a2)
        throws edu.iris.Fissures.IfTimeSeries.SequenceOutOfOrder
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_long(_ob_a0);
                    edu.iris.Fissures.IfTimeSeries.EncodedSeqHelper.write(out, _ob_a1);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a2);
                    in = _invoke(out);
                    return;
                }
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    out.write_long(_ob_a0);
                    edu.iris.Fissures.IfTimeSeries.EncodedDataHelper.write(out, _ob_a1);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a2);
                    in = _invoke(out);
                    return;
                }
