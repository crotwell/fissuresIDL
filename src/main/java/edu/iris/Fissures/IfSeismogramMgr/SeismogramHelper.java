...
//
final public class SeismogramHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Seismogram");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfSeismogramMgr/Seismogram:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _SeismogramStub _ob_stub = new _SeismogramStub();
