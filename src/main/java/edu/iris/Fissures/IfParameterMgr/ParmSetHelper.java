...
//
final public class ParmSetHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "ParmSet");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfParameterMgr/ParmSet:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ParmSetStub _ob_stub = new _ParmSetStub();
