...
//
final public class DataSetHelper
{
    public static void
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof DataSet)
                    return (DataSet)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "DataSet");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfDataSetMgr/DataSet:1.0";
    }
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _DataSetStub _ob_stub = new _DataSetStub();
