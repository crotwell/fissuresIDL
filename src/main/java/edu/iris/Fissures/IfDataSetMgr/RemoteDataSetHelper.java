...
//
final public class RemoteDataSetHelper
{
    public static void
    insert(org.omg.CORBA.Any any, RemoteDataSet val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "RemoteDataSet");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfDataSetMgr/RemoteDataSet:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _RemoteDataSetStub _ob_stub = new _RemoteDataSetStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, RemoteDataSet val)
    {
