...
//
public class _DataSetAccessStub extends org.omg.CORBA.portable.ObjectImpl
                                implements DataSetAccess
{
    ...
    final public static java.lang.Class _ob_opsClass = DataSetAccess.class;
    ...
    a_writeable()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                DataSetAccess _ob_self = (DataSetAccess)_ob_so.servant;
                try
                {
