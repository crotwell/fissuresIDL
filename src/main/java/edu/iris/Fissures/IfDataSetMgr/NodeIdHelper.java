...
//
// IDL:iris.edu/Fissures/IfDataSetMgr/NodeId:1.0
//
final public class NodeIdHelper
{
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "NodeId", orb.get_primitive_tc(org.omg.CORBA.TCKind.tk_string));
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfDataSetMgr/NodeId:1.0";
    }
