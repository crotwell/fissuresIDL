...
//
public class _DataCenterStub extends org.omg.CORBA.portable.ObjectImpl
                             implements DataCenter
{
    ...
    final public static java.lang.Class _ob_opsClass = DataCenterOperations.class;
    ...
    available_data(RequestFilter[] _ob_a0)
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                DataCenterOperations _ob_self = (DataCenterOperations)_ob_so.servant;
                try
                {
