...
//
final public class DataCenterHelper
{
    public static void
    insert(org.omg.CORBA.Any any, DataCenter val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "DataCenter");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfSeismogramDC/DataCenter:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _DataCenterStub _ob_stub = new _DataCenterStub();
        _ob_stub._set_delegate(_ob_impl._get_delegate());
        return _ob_stub;
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, DataCenter val)
    {
