...
//
final public class AuditSystemAccessHelper
{
    public static void
    insert(org.omg.CORBA.Any any, AuditSystemAccess val)
    {
    ...
    public static AuditSystemAccess
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof AuditSystemAccess)
                    return (AuditSystemAccess)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "AuditSystemAccess");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/AuditSystemAccess:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, AuditSystemAccess val)
    {
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _AuditSystemAccessStub _ob_stub = new _AuditSystemAccessStub();
