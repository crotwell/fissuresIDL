...
//
final public class SeismogramAccessHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "SeismogramAccess");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfSeismogramMgr/SeismogramAccess:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _SeismogramAccessStub _ob_stub = new _SeismogramAccessStub();
