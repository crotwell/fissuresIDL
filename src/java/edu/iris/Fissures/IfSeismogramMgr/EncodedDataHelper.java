...
//
// IDL:iris.edu/Fissures/IfSeismogramMgr/EncodedData:1.0
//
final public class EncodedDataHelper
{
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_alias_tc(id(), "EncodedData", edu.iris.Fissures.IfTimeSeries.EncodedDataHelper.type());
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfSeismogramMgr/EncodedData:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ob_v = edu.iris.Fissures.IfTimeSeries.EncodedDataHelper.read(in);
        return _ob_v;
    }
    ...
    {
        edu.iris.Fissures.IfTimeSeries.EncodedDataHelper.write(out, val);
    }
}
