...
//
public abstract class EventSeqIterPOA
               ...
               EventSeqIterOperations
{
    ...
    _this()
    {
        return EventSeqIterHelper.narrow(super._this_object());
    }

    public EventSeqIter
    _this(org.omg.CORBA.ORB orb)
    {
        return EventSeqIterHelper.narrow(super._this_object(orb));
    }
                  ...
                  org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        EventAccessSeqHolder _ob_ah1 = new EventAccessSeqHolder();
        boolean _ob_r = next_n(_ob_a0, _ob_ah1);
        out = handler.createReply();
        out.write_boolean(_ob_r);
        EventAccessSeqHelper.write(out, _ob_ah1.value);
        return out;
    }
}
