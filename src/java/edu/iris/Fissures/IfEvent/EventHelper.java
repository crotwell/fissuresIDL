...
//
final public class EventHelper
{
    public static void
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_interface_tc(id(), "Event");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfEvent/Event:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _EventStub _ob_stub = new _EventStub();
