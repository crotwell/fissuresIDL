...
//
final public class NetworkAttrHelper
{
    public static void
    insert(org.omg.CORBA.Any any, NetworkAttr val)
    {
        any.insert_Value(val, type());
    }

    public static NetworkAttr
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            java.io.Serializable _ob_v = any.extract_Value();
            if(_ob_v instanceof NetworkAttr)
                return (NetworkAttr)_ob_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_value_tc(id(), "NetworkAttr", org.omg.CORBA.VM_NONE.value, null, members);
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/NetworkAttr:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (NetworkAttr)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, NetworkAttr val)
    {
