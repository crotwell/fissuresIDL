...
//
public abstract class ChannelIdIterPOA
               ...
               ChannelIdIterOperations
{
    ...
    public ChannelIdIter
    _this()
    {
        return ChannelIdIterHelper.narrow(super._this_object());
    }

    public ChannelIdIter
    _this(org.omg.CORBA.ORB orb)
    {
        return ChannelIdIterHelper.narrow(super._this_object(orb));
    }
                  ...
                  org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        ChannelIdSeqHolder _ob_ah1 = new ChannelIdSeqHolder();
        boolean _ob_r = next_n(_ob_a0, _ob_ah1);
        out = handler.createReply();
        out.write_boolean(_ob_r);
        ChannelIdSeqHelper.write(out, _ob_ah1.value);
        return out;
    }
}
