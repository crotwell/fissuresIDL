...
//
final public class SensorHelper
{
    public static void
    insert(org.omg.CORBA.Any any, Sensor val)
    {
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[0].name = "nominal_high_freq";
            ...
            members[1].name = "nominal_low_freq";
            ...
            typeCode_ = orb.create_value_tc(id(), "Sensor", org.omg.CORBA.VM_NONE.value, baseType, members);
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/Sensor:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (Sensor)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, Sensor val)
    {
