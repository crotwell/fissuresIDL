...
//
final public class TimeCorrectionHelper
{
    public static void
    insert(org.omg.CORBA.Any any, TimeCorrection val)
    {
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            if(_ob_v instanceof TimeCorrection)
                return (TimeCorrection)_ob_v;
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            members[0].name = "effective_time";
            members[0].type = edu.iris.Fissures.TimeRangeHelper.type();
            members[0].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            members[1] = new org.omg.CORBA.ValueMember();
            members[1].name = "begin_offset";
            members[1].type = edu.iris.Fissures.TimeIntervalHelper.type();
            members[1].access = org.omg.CORBA.PUBLIC_MEMBER.value;

            members[2] = new org.omg.CORBA.ValueMember();
            members[2].name = "end_offset";
            ...
            typeCode_ = orb.create_value_tc(id(), "TimeCorrection", org.omg.CORBA.VM_NONE.value, null, members);
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/TimeCorrection:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        return (TimeCorrection)((org.omg.CORBA_2_3.portable.InputStream)in).read_value(id());
    }

    public static void
    write(org.omg.CORBA.portable.OutputStream out, TimeCorrection val)
    {
