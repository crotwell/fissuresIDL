...
final public class NetworkHelper
{
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof Network)
                    return (Network)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "Network");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfNetwork/Network:1.0";
    }
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _NetworkStub _ob_stub = new _NetworkStub();
