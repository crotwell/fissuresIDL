...
//
public class _VirtualNetworkStub extends org.omg.CORBA.portable.ObjectImpl
                                 implements VirtualNetwork
{
    ...
    final public static java.lang.Class _ob_opsClass = VirtualNetworkOperations.class;
        ...
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    ...
                    in = _invoke(out);
                    VirtualNetwork _ob_r = VirtualNetworkHelper.read(in);
                    return _ob_r;
                }
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                VirtualNetworkOperations _ob_self = (VirtualNetworkOperations)_ob_so.servant;
                try
                {
        ...
        throws DuplicateChannelId
    {
        while(true)
        {
            ...
            else
            {
                ...
                try
                {
                    _ob_self.add_channel(_ob_a0, _ob_a1);
                    return;
                }
                finally
                {
    ...
    //
    public void
    remove_channel(ChannelId _ob_a0,
                   edu.iris.Fissures.AuditInfo[] _ob_a1)
        throws ChannelNotFound
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("remove_channel", true);
                    ChannelIdHelper.write(out, _ob_a0);
                    edu.iris.Fissures.AuditInfoOptHelper.write(out, _ob_a1);
                    in = _invoke(out);
                    return;
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("remove_channel", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                VirtualNetworkOperations _ob_self = (VirtualNetworkOperations)_ob_so.servant;
                try
                {
                    _ob_self.remove_channel(_ob_a0, _ob_a1);
                    return;
                }
                finally
                {
    ...
    get_network_for_channel(ChannelId _ob_a0)
        throws ChannelNotFound,
               ConcreteNetworkNotAvailable
    {
        while(true)
        {
            if(!this._is_local())
            {
                ...
                try
                {
                    out = _request("get_network_for_channel", true);
                    ChannelIdHelper.write(out, _ob_a0);
                    in = _invoke(out);
                    ConcreteNetworkAccess _ob_r = ConcreteNetworkAccessHelper.read(in);
                    return _ob_r;
                }
                catch(org.omg.CORBA.portable.RemarshalException _ob_ex)
                {
                ...
                catch(org.omg.CORBA.portable.ApplicationException _ob_aex)
                {
                    ...
                    if(_ob_id.equals(ChannelNotFoundHelper.id()))
                        throw ChannelNotFoundHelper.read(in);
                    if(_ob_id.equals(ConcreteNetworkNotAvailableHelper.id()))
                        throw ConcreteNetworkNotAvailableHelper.read(in);
                    throw new org.omg.CORBA.UNKNOWN("Unexpected User Exception: " + _ob_id);
                }
                finally
                {
            ...
            {
                org.omg.CORBA.portable.ServantObject _ob_so = _servant_preinvoke("get_network_for_channel", _ob_opsClass);
                if(_ob_so == null)
                    continue;
                VirtualNetworkOperations _ob_self = (VirtualNetworkOperations)_ob_so.servant;
                try
                {
                    return _ob_self.get_network_for_channel(_ob_a0);
                }
                finally
                {
                    _servant_postinvoke(_ob_so);
