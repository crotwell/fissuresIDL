...
//
final public class FissuresIteratorHelper
{
    public static void
    insert(org.omg.CORBA.Any any, FissuresIterator val)
    {
    ...
    public static FissuresIterator
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof FissuresIterator)
                    return (FissuresIterator)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "FissuresIterator");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/FissuresIterator:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, FissuresIterator val)
    {
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _FissuresIteratorStub _ob_stub = new _FissuresIteratorStub();
