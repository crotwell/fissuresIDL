...
{
    public static void
    insert(org.omg.CORBA.Any any, TimeSeriesAdmin val)
    {
    ...
    extract(org.omg.CORBA.Any any)
    {
        if(any.type().equivalent(type()))
        {
            ...
            catch(org.omg.CORBA.BAD_OPERATION ex)
            {
                ...
                if(_ob_v instanceof TimeSeriesAdmin)
                    return (TimeSeriesAdmin)_ob_v;
            }
        }
    ...
    type()
    {
        if(typeCode_ == null)
        {
            ...
            typeCode_ = orb.create_abstract_interface_tc(id(), "TimeSeriesAdmin");
        }
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfTimeSeries/TimeSeriesAdmin:1.0";
    }
    ...
    public static void
    write(org.omg.CORBA.portable.OutputStream out, TimeSeriesAdmin val)
    {
        ...
        if(val != null)
        {
            ...
            if(val instanceof org.omg.CORBA.Object)
            {
                ...
                if(_ob_o._is_a(id()))
                {
                    ...
                    _TimeSeriesAdminStub _ob_stub = new _TimeSeriesAdminStub();
