...
final public class ComplexNumberHelper
{
    ...
    id()
    {
        return "IDL:iris.edu/Fissures/IfTimeSeries/ComplexNumber:1.0";
    }
    ...
    read(org.omg.CORBA.portable.InputStream in)
    {
        ...
        _ob_v.real_part = in.read_float();
        _ob_v.imaginary_part = in.read_float();
        return _ob_v;
    }
    ...
    {
        out.write_float(val.real_part);
        out.write_float(val.imaginary_part);
    }
}
