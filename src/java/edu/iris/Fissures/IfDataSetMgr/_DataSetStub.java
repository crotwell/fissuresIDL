...
//
public class _DataSetStub extends org.omg.CORBA.portable.ObjectImpl
                          implements DataSet
{
    ...
    final public static java.lang.Class _ob_opsClass = DataSet.class;
    ...
    a_writeable()
    {
        while(true)
        {
            ...
            else
            {
                ...
                if(_ob_so == null)
                    continue;
                DataSet _ob_self = (DataSet)_ob_so.servant;
                try
                {
