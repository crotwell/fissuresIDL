...
//
public abstract class ParameterNameIteratorPOA
               ...
               ParameterNameIteratorOperations
{
    ...
    public ParameterNameIterator
    _this()
    {
        return ParameterNameIteratorHelper.narrow(super._this_object());
    }

    public ParameterNameIterator
    _this(org.omg.CORBA.ORB orb)
    {
        return ParameterNameIteratorHelper.narrow(super._this_object(orb));
    }
                  ...
                  org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        ParameterNameSeqHolder _ob_ah1 = new ParameterNameSeqHolder();
        boolean _ob_r = next_n(_ob_a0, _ob_ah1);
        out = handler.createReply();
        out.write_boolean(_ob_r);
        ParameterNameSeqHelper.write(out, _ob_ah1.value);
        return out;
    }
                    ...
                    org.omg.CORBA.portable.ResponseHandler handler)
    {
        ...
        out = handler.createReply();
        out.write_boolean(_ob_r);
        ParameterNameHelper.write(out, _ob_ah0.value);
        return out;
    }
