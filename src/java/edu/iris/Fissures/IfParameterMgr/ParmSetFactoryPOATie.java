...
public class ParmSetFactoryPOATie extends ParmSetFactoryPOA
{
    ...
    public
    ParmSetFactoryPOATie(ParmSetFactoryOperations delegate)
    {
        _ob_delegate_ = delegate;
    }

    public
    ParmSetFactoryPOATie(ParmSetFactoryOperations delegate, org.omg.PortableServer.POA poa)
    {
        _ob_delegate_ = delegate;
        _ob_poa_ = poa;
    }

    public ParmSetFactoryOperations
    _delegate()
    {
    ...
    public void
    _delegate(ParmSetFactoryOperations delegate)
    {
        _ob_delegate_ = delegate;
    }
    ...
    {
        _ob_delegate_.create_parameter_def(parm_definition);
    }
