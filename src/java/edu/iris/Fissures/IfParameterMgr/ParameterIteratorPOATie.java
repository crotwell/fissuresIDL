...
public class ParameterIteratorPOATie extends ParameterIteratorPOA
{
    ...
    public
    ParameterIteratorPOATie(ParameterIteratorOperations delegate, org.omg.PortableServer.POA poa)
    {
        _ob_delegate_ = delegate;
        _ob_poa_ = poa;
    }

    public ParameterIteratorOperations
    _delegate()
    {
    ...
    {
        return _ob_delegate_.next_one(parameter);
    }
